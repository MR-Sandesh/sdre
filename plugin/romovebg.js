...
const tourl = async (m, fox) => {
  ...
  if (validCommands.includes(cmd)) {
    ...
    removeBackgroundFromImageFile({
      ...
      fox.sendMessage(m.from, { image: fs.readFileSync(outputFilePath), caption: `> Hey ${m.pushName} Your picture Background Romoved Sucessfully` }, { quoted: m });
