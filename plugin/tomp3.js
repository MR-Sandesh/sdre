import { toAudio } from '../auth_lib/converter.cjs'; // Import statement placed outside the try block

const tomp3 = async (m, fox) => {
  try {
    ...
    await fox.sendMessage(m.from, { document: audio, mimetype: 'audio/mpeg', fileName: `Converted By ${fox.user.name}.mp3` }, { quoted: m });
  } catch (error) {
