...
const githubStalk = async (m, fox) => {
  ...
  ◦  *Forks*: ${repo.forks}`;
        ...
        await fox.sendMessage(m.from, { image: { url: userData.avatar_url }, caption: responseMessage }, { quoted: m });
      } catch (error) {
        console.error('Error fetching GitHub data:', error);
        await fox.sendMessage(m.from, 'An error occurred while fetching GitHub data.', { quoted: m });
      }
    }
  } catch (error) {
